"""
ShuffleNet V2 0.5x Training for Tomato Dataset (Data Augmentation Enabled)
...
def main():
    print("="*60)
    print("ShuffleNet V2 0.5x Training (Data Augmentation Enabled)")
    ...
    checkpoint_dir = './checkpoints_tomato_0_5x_aug'
