"""
ShuffleNet V2 1.0x Transfer Learning Training Script (GPU, 50 epoch)
...
CHECKPOINT_DIR = './checkpoints_tomato_1_0x_transfer_gpu'
...
earlystop = EarlyStopping(monitor='val_accuracy', patience=50, restore_best_weights=True)  # 50 epoch garanti

print('Model eğitiliyor (1.0x transfer learning, augmentation yok, GPU)...')
history = model.fit(
    train_gen,
    epochs=EPOCHS,
