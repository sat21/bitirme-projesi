# Keras ile ShuffleNetV2 2.0x (transfer learning, augmentation yok, GPU)
...
CHECKPOINT_DIR = './checkpoints_tomato_2_0x_transfer_gpu_noaug'
...
# ShuffleNetV2 2.0x backbone (projeye eklenen Keras implementasyonu, son katman hariç)
base_model = ShuffleNetV2(input_shape=(IMAGE_SIZE, IMAGE_SIZE, 3), n_classes=NUM_CLASSES, scale_factor=2.0)
...
print('Model eğitiliyor (ShuffleNetV2 2.0x transfer learning, augmentation yok, GPU)...')
history = model.fit(
    train_gen,
    epochs=EPOCHS,
