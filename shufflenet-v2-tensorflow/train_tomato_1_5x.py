"""
ShuffleNet V2 1.5x Baseline Training for Tomato Dataset
...
def depthwise_conv_bn(x, kernel_size, strides=1):
    """Depthwise Convolution + BatchNorm"""
...
def load_batch(image_paths, labels):
    """Batch yükle ve ön işle"""
    batch_images = []
...
def main():
    print("="*60)
    print("ShuffleNet V2 1.0 Baseline Training")
    ...
    # Callbacks
    checkpoint_dir = './checkpoints_tomato_1_5x_baseline'
